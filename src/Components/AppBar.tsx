        ...
        <StyledToolbar variant="dense" disableGutters>
          <Box sx={{ flexGrow: 1, display: 'flex', alignItems: 'center', px: 0 }}>
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
              ...
              <Button variant="text" color="info" size="small" onClick={() => handleScroll('testimonials')}>
                Testimonials
              </Button>
              ...
              <Button variant="text" color="info" size="small" sx={{ minWidth: 0 }} onClick={() => handleScroll('blog')}>
                Blog
              </Button>
            </Box>
          </Box>
